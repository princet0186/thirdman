          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              <h2 className="text-sm font-bold text-[#0f172a] flex items-center gap-2">
                ...
                Momentum & Form Analytics
              </h2>
              <p className="text-xs text-[#64748b] mt-1">Predicting peak performance windows for top order batsmen.</p>
            </div>
          </div>
          
          <div className="flex-1 flex items-center justify-center border-2 border-dashed border-[#e2e8f0] rounded bg-[#f8fafc]">
             <div className="text-center">
               <LineChart className="w-8 h-8 text-[#94a3b8] mx-auto mb-2" />
               <p className="text-sm font-mono text-[#64748b]">FORMCAST_TRAJECTORY_CHART</p>
               <p className="text-xs text-[#94a3b8] mt-1">Rolling strike-rate averages and momentum graphs would render here.</p>
             </div>
          </div>
        </div>
      </div>
