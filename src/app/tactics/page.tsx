        ...
        <div className="bg-white border border-[#cbd5e1] rounded-sm shadow-sm p-3 flex-1 flex flex-col">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-xs text-[#64748b] mt-1">Visualizing spin vs pace vulnerabilities on subcontinent pitches.</p>
            </div>
          </div>
          
          <div className="flex-1 flex items-center justify-center border-2 border-dashed border-[#e2e8f0] rounded bg-[#f8fafc]">
             <div className="text-center">
               <Crosshair className="w-8 h-8 text-[#94a3b8] mx-auto mb-2" />
               <p className="text-sm font-mono text-[#64748b]">OPPONENT_EDGE_PITCH_MAP</p>
               <p className="text-xs text-[#94a3b8] mt-1">Wagon wheels, pitch maps, and matchup matrices would render here.</p>
             </div>
          </div>
        </div>
      </div>
