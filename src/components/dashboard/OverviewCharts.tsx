  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div className="flex flex-col">
        <div className="text-[10px] font-mono text-[#64748b] mb-2 uppercase flex justify-between items-center">
          <span>Target Profile (Radar)</span>
          <span className="text-[#3b82f6] transition-all duration-300" style={{ opacity: 1 }}>
            ID: {selectedPlayer.id}
          </span>
        </div>
        <div className="h-[180px] w-full bg-[#f8fafc] border border-[#e2e8f0] p-1 transition-all duration-300">
