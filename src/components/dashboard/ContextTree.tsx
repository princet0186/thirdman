    ...
    <div className="py-2">
      <div className="px-2">
        ...
        <ul className="text-xs space-y-0.5">
          ...
          <li>
            <button className="w-full flex items-center gap-1.5 px-2 py-1.5 hover:bg-[#f0ebe0] text-[#0f172a] rounded-sm text-left mt-1">
              <ChevronRight className="w-3 h-3 text-[#b8976a]" />
              <Database className="w-3.5 h-3.5 text-[#166534]" />
